...
/*!
 	 ...
 	 \return void
 */
void NVIC_enableInterruptAndPriority(InterruptType interruptNumber, PriorityLevelType priority);//PASAR INTERRUPCION Y PRIORIDAD
/********************************************************************************************/
/********************************************************************************************/
/********************************************************************************************/
/*!
 ...
 */
void NVIC_setBASEPRI_threshold(PriorityLevelType priority);//CAMBIAR DE MANERA DINAMICA EL NIVEL DE INTERRUPCIONES NO QUIERO QUE ME INTERRUMPA EL GPIO Y LE SUBES EL NIVEL DE PRIORIDAD Y NO LO HARA
